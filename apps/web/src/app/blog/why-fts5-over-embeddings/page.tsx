...
export const metadata: Metadata = {
  ...
  description:
    "Vector embeddings are powerful but overkill for most AI memory use cases. SQLite FTS5 gave us instant startup, zero dependencies, and 46MB less bloat. Here's why simpler won.",
  keywords:
    "FTS5, embeddings, vector search, AI memory, BM25, SQLite, memory-mcp, sentence transformers, full-text search",
};
    ...
    <main className="min-h-screen text-white">
      <article className="container mx-auto px-4 py-12 max-w-3xl">
        <BlogHeader
          ...
          readTime="8 min read"
          tags={[{ label: "Architecture" }, { label: "Technical" }]}
        />

        {/* Content */}
        <div className="prose prose-invert prose-lg max-w-none">
          <p className="text-xl text-gray-300 mb-8">
            When we rewrote memory-mcp from Python to TypeScript, we made a
            controversial decision: drop vector embeddings entirely in favor of
            SQLite&apos;s FTS5. The result? 46MB less bloat, instant startup,
            and search that actually works better for our use case.
          </p>
          ...
          <div className="bg-forge-cyan/10 border border-forge-cyan/30 rounded-xl p-6 mb-8">
            ...
            <ul className="text-gray-300 mb-0 space-y-1">
              <li>
                <strong>46MB saved</strong> - No more sentence-transformers
                model weight
              </li>
              <li>
                <strong>30+ seconds → &lt;1s startup</strong> - No model loading
              </li>
              <li>
                <strong>1,500+ tokens saved</strong> per response (no embedding
                bloat)
              </li>
              <li>
                <strong>88 tokens</strong> for hot context retrieval (tested)
              </li>
            </ul>
          </div>
          ...
          <p className="text-gray-300 mb-4">
            Vector embeddings have become the default answer for anything
            involving search. Need to find similar documents? Embeddings.
            Semantic search? Embeddings. AI memory? Obviously embeddings.
          </p>
          <p className="text-gray-300 mb-4">
          ...
          <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4 mb-4">
            <ul className="text-gray-300 mb-0 space-y-1">
              <li>
                <strong>46MB+</strong> model weight downloaded on first run
              </li>
              <li>
                <strong>30+ seconds</strong> cold start (loading the model)
              </li>
              <li>
                <strong>2+ seconds</strong> latency reported by users
              </li>
              <li>
                <strong>Entire JSON file</strong> loaded into RAM
              </li>
              <li>
                <strong>No concurrent access</strong> - file locks everywhere
              </li>
            </ul>
          </div>
          ...
          <p className="text-gray-300 mb-4">
            Someone forked the original and tried to &quot;fix&quot; it by
          ...
          <p className="text-gray-300 mb-4">
            For a personal memory tool. Running locally. With maybe 100-1,000
            memories.
          </p>
          <p className="text-gray-300 mb-4">
            They learned an important lesson and documented it before archiving
            the project:
          </p>
          <blockquote className="border-l-4 border-forge-cyan pl-4 italic text-gray-400 mb-4">
            &quot;After implementing and then removing the auto-capture feature,
            here is the correct understanding of how MCP works: Servers can only
            respond to requests, not initiate actions.&quot;
          </blockquote>
          <p className="text-gray-300 mb-4">
            The fork was abandoned. Over-engineering doesn&apos;t survive
              ...
              <tbody className="text-gray-300">
                ...
                <tr className="border-b border-white/10">
                  ...
                  <td className="py-3 px-2">
                    Semantic meaning crosses language
                  </td>
                </tr>
                <tr className="border-b border-white/10">
                ...
                <tr className="border-b border-white/10">
                  ...
                  <td className="py-3 px-2">
                    Keyword search is faster and simpler
                  </td>
                </tr>
                <tr className="border-b border-white/10">
                ...
                <tr className="border-b border-white/10">
                  ...
                  <td className="py-3 px-2 text-red-400">No</td>
                  <td className="py-3 px-2">
                    46MB model + startup cost kills UX
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <p className="text-gray-300 mb-4">
            Personal AI memory is firmly in the &quot;No&quot; category.
            You&apos;re not searching millions of documents. You&apos;re
            recalling dozens to hundreds of memories you created yourself.
          </p>
          ...
          <p className="text-gray-300 mb-4">
            SQLite&apos;s FTS5 (Full-Text Search 5) is built into SQLite. No
            external dependencies. It provides:
          </p>
          <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-2">
            <li>
              <strong>BM25 ranking</strong> - The same algorithm behind
              Elasticsearch and Lucene
            </li>
            <li>
              <strong>Phrase queries</strong> - Search for &quot;authentication
              flow&quot; as a phrase
            </li>
            <li>
            ...
            <li>
              <strong>Prefix matching</strong> - auth* matches authentication,
              authorize, etc.
            </li>
            <li>
              <strong>Column weights</strong> - Prioritize title matches over
              body matches
            </li>
          </ul>
          <p className="text-gray-300 mb-4">
          ...
          <div className="bg-black/30 rounded-lg p-4 font-mono text-sm mb-4">
            <code className="text-gray-300">
              score = 0.4 * relevance + 0.3 * importance + 0.2 * recency + 0.1 *
              frequency
            </code>
          </div>
          <p className="text-gray-300 mb-4">
            This means a highly relevant but older memory can still rank above a
            recent but tangentially related one. The weights are tunable, but
            these defaults work well.
          </p>
          ...
          <p className="text-gray-300 mb-4">
            Here&apos;s something embedding-based systems get wrong: they ignore
            token cost.
          </p>
          <p className="text-gray-300 mb-4">
            When Claude calls{" "}
            <code className="text-forge-cyan">memory_recall</code>, we need to
            return memories that fit within context limits. The old Python
          ...
          <p className="text-gray-300 mb-4">
            Result: 1,500+ tokens per response in some cases. Most of it useless
            to Claude.
          </p>
          <p className="text-gray-300 mb-4">
          ...
          <p className="text-gray-300 mb-4">
            Hot context (the most relevant memories) tested at just 88 tokens.
            That&apos;s 17x more efficient than the embedding-bloated responses.
          </p>
          ...
          <p className="text-gray-300 mb-4">
            MCP servers need to start fast. Every time you restart Claude
            Desktop, every MCP server initializes. With the old Python version:
          </p>
          ...
          <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-2">
            <li>
              <strong>Semantic similarity</strong> - &quot;car&quot; won&apos;t
              match &quot;automobile&quot; unless you explicitly store both
            </li>
            <li>
              <strong>Typo tolerance</strong> - &quot;authenication&quot;
              won&apos;t find &quot;authentication&quot;
            </li>
            <li>
              <strong>Cross-lingual</strong> - Can&apos;t search English
              memories with French queries
            </li>
          </ul>
          <p className="text-gray-300 mb-4">
            For personal AI memory, these tradeoffs are acceptable. You wrote
            the memories. You know roughly what words you used. And if you need
            semantic search at scale, use a dedicated solution like Pinecone or
            Qdrant.
          </p>
...
└── Hybrid scoring query
    └── BM25 + importance + recency + frequency`}</pre>
          ...
          <p className="text-gray-300 mb-4">
            Three tools. One database file. Zero external dependencies beyond
            better-sqlite3 (and we&apos;re migrating to Bun&apos;s built-in
            SQLite to eliminate even that).
          </p>
          ...
          <p className="text-gray-300 mb-4">
            The industry&apos;s default answer to search is &quot;add
            embeddings.&quot; For large-scale semantic search, that&apos;s
            right. For personal AI memory with 100-1,000 items, it&apos;s
            over-engineering.
          </p>
          <p className="text-gray-300 mb-4">FTS5 gave us:</p>
          <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-2">
          ...
          posts={[
            {
              ...
              description: "Python to TypeScript migration",
            },
            {
              href: "/blog/memory-mcp-vs-alternatives",
              title: "MCP Memory Servers Compared",
              description: "memory-mcp vs the alternatives",
            },
          ]}
        />
      </article>
