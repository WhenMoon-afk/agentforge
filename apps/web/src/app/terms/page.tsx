...
export const metadata: Metadata = {
  ...
  description: 'Terms of service for Substratia - rules and guidelines for using our services.',
}
        ...
        <div className="prose prose-invert prose-cyan max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-300 mb-4">
              By accessing or using Substratia (&quot;the Service&quot;), you agree to be bound by these
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 mb-4">
              ...
              you grant us a limited license to store and process it solely to provide the Service.
            </p>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-white mb-4">Open Source Tools</h2>
            <p className="text-gray-300 mb-4">
              Our open-source tools (momentum, memory-mcp) are provided under the MIT License.
              These tools are provided &quot;as is&quot; without warranty of any kind.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-white mb-4">Paid Services</h2>
            <p className="text-gray-300 mb-4">
